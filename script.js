...
const requirementsData = [
  { letter: 'A', icon: '📝', title: 'Certificate of Candidacy',    desc: 'Accomplished form with 2×2 ID photo attached.' },
  { letter: 'B', icon: '🎓', title: 'Certificate of Good Moral',   desc: 'Issued by the university or your college.' },
  { letter: 'C', icon: '📊', title: 'Grade Slip',                  desc: 'Official grades from the previous semester.' },
  { letter: 'D', icon: '📄', title: 'Certificate of Registration', desc: 'Valid COR for the current semester.' },
  { letter: 'E', icon: '✍️', title: 'Endorsement Letters',         desc: 'From your Dean and Department Head. If no Dept. Head, Dean signature suffices.' },
  { letter: 'F', icon: '📁', title: 'Curriculum Vitae',            desc: 'Most recent copy of your CV.' },
  { letter: 'G', icon: '📌', title: 'General Plan of Action',      desc: 'Comprehensive plan required for all candidates — independent or party member.' },
  { letter: 'H', icon: '👥', title: 'Party Submission Rule',       desc: 'Parties must submit as a group. Incomplete party = automatically independent.' },
];
